...
namespace PARK.JONG.SOO.Controllers.ApplicationControlls
{
    public class ApplicationRolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Description,CreatedDate,IPAddress,Id,Name,NormalizedName,ConcurrencyStamp")] ApplicationRole applicationRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Description,CreatedDate,IPAddress,Id,Name,NormalizedName,ConcurrencyStamp")] ApplicationRole applicationRole)
        {
